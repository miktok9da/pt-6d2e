...
def generate_story_with_pollinations(topic: str) -> str:
    ...
    system = "You are a historian specializing in ancient women history. Write a short 30-second interesting story (80-130 words) in Portuguese. Tell real historical facts, laws, customs, or traditions. Use a lively, captivating style. No titles."
    prompt = f"Theme: {topic}. Tell an interesting historical fact in Portuguese."
    ...
    for attempt in range(3):
        ...
        return f"Há muito tempo, no mundo antigo, as mulheres moldaram leis, costumes e a vida cotidiana de maneiras notáveis. {topic}. Suas histórias de coragem, habilidade e resiliência ecoam pela história e ainda nos inspiram hoje."
...
def generate_tts(story: str):
    ...
    print("[tts] Generating Portuguese narration with edge-tts...")
    
    VOICE = "pt-BR-AntonioNeural"  # Brazilian Portuguese male voice (or use "pt-BR-FranciscaNeural" for female)
...
def generate_word_subtitles():
    ...
    print("[subs] Generating word-level Portuguese subtitles with Vosk...")
    ...
    if not os.path.exists(model_path):
        print("[subs] Downloading Vosk Portuguese model (~31 MB)...")
